...
mod tests {
    ...
    Q::Vector { id: "resolver-exact-record-with-family-route-probe", provider: "databricks_v2", raw_model_id: "databricks-gpt-5-6-sol", note: Some("Probes an exact record whose wire route is materialized from its family rule.") },
    Q::Vector { id: "dbv2-gpt5-5-exact-record-probe", provider: "databricks_v2", raw_model_id: "databricks-gpt-5-5", note: Some("Probes an exact record whose advertised efforts differ from its family rule.") },
    ...
    Q::Vector { id: "dbv2-gpt5-10-route-preservation-probe", provider: "databricks_v2", raw_model_id: "databricks-gpt-5-10", note: Some("Probes a databricks_v2 gpt-5-<multi-digit> id, exercising both the effort axes and the wire route.") },
    Q::Vector { id: "dbv2-gpt-5-2-divergent-exact-record-probe", provider: "databricks_v2", raw_model_id: "databricks-gpt-5-2", note: Some("Probes the sole deliberately-divergent exact record, whose pinned snapshot differs from what the gpt-5 base stem would produce.") },
